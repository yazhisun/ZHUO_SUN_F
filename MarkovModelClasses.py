...
class PatientStateMonitor:
    ...
    def update(self, k, next_state):
        ...
        if next_state == P.HealthStats.LUNG_DEATH: #P.HealthStats.NON_LUNG_DEATH]:
    ...
    def get_if_alive(self):
        result = True
        if self._currentState == P.HealthStats.LUNG_DEATH:
            result = False
        return result
...
class PatientCostUtilityMonitor:
    ...
    def update(self, k, current_state, next_state):
        ...
        # if death will occur
        if next_state == P.HealthStats.LUNG_DEATH:
